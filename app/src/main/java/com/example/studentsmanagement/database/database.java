package com.example.studentsmanagement.database;
...
public class database extends SQLiteOpenHelper {
    ...
    public Cursor getDataSubject(){
        ...
        // getWritableDatabase() cả đọc và ghi
        // getReadableDatabase() chỉ đọc, không đucợ chỉnh sửa, không cần thiết thì dùng Read cho tối ưu
